...
- 2026-03-19: target domain の例示を `prosports.yoshilover.com` 向けに揃えるため、UI placeholder と `docs/wordpress-cluster-operations.md` の `pillar / cluster` サンプルをスポーツ系の文言へ更新した。
